...
flags.DEFINE_integer('output_size', DEFAULT_FEATURE_SIZE, 'output size - use this if you want to train a classififcation model')
...
def main(_argv):
    ...
    tripletgen_train = batchgen.ImageGenerator(X_train, Y_train, ap_pairs = FLAGS.num_ap_pairs, an_pairs = FLAGS.num_an_pairs, batch_size = FLAGS.batch_size, shuffle = True, renew = True, images_as_path = True, image_size = input_size)
    tripletgen_test = batchgen.ImageGenerator(X_test, Y_test, ap_pairs = FLAGS.num_ap_pairs, an_pairs = FLAGS.num_an_pairs, batch_size = FLAGS.batch_size, shuffle = False, renew = False, images_as_path = True, image_size = input_size)
